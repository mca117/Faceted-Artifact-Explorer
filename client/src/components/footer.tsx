      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between">
          <div className="mb-6 md:mb-0">
            <h2 className="font-serif text-xl font-bold mb-4">Faceted Artifact Explorer</h2>
            <p className="text-primary-200 text-sm max-w-md">
              A comprehensive digital platform for exploring archaeological artifacts through advanced search, 3D visualization, and detailed metadata.
            </p>
          </div>
        ...
        <div className="border-t border-primary-700 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-primary-300">© {new Date().getFullYear()} Faceted Artifact Explorer. All rights reserved.</p>
